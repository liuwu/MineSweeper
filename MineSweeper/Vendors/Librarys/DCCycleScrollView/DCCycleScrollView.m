...
-(void)layoutSubviews
{
    ...
    self.collectionView.frame = self.bounds; //CGRectMake(0, 0.f, self.bounds.size.width, 150.f);
    self.pageControl.frame = CGRectMake(0, self.bounds.size.height + 10, self.bounds.size.width, 30);
...
-(UICollectionView *)collectionView
{
    ...
    {
        _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0., 0.f, self.width, 150.f) collectionViewLayout:self.flowLayout];
