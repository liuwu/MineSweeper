...
@interface LWLoginTextField()

@property (nonatomic, strong) UIButton *leftIconBtn;//默认的leftIcon
@property (nonatomic, strong) UIView *customLeftView;//默认的leftView，是_leftIconBtn的父视图
@property (nonatomic, strong) UIView *customRightView;//默认的rightView

@end


@implementation LWLoginTextField
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.defaultBorderColor = [UIColor grayColor];
...
//        self.textColor = [UIColor whiteColor];
        ...
        self.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter; //设置居中输入
        ...
        _customRightView.frame = leftRect;
...
- (void)setRightIconView:(UIView *)rightIconView {
    _rightIconView = rightIconView;
    
    if (_rightIconView != nil) {
        [_customRightView addSubview:_rightIconView];
        _rightIconView.size = CGSizeMake(20, 20);
