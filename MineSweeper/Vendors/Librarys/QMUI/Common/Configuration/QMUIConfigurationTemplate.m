...
#pragma mark - Global Color
    ...
    QMUICMI.separatorColor =  UIColorMake(242, 242, 242);//UIColorMake(222, 224, 226);                        // UIColorSeparator : 全局默认的分割线颜色，默认用于列表分隔线颜色、UIView (QMUI_Border) 分隔线颜色
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarButtonFontBold = UIFontMake(15);                          // NavBarButtonFontBold : QMUINavigationButtonTypeBold 的字体
    QMUICMI.navBarBackgroundImage = [UIImage imageWithColor:WLColoerRGB(255.f)];//UIImageMake(@"home_boom_img");   // NavBarBackgroundImage : UINavigationBar 的背景图
    QMUICMI.navBarShadowImage = [UIImage imageWithColor:WLColoerRGB(248.f)];//[UIImage new];                                  // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线
    QMUICMI.navBarBarTintColor = nil;                                           // NavBarBarTintColor : UINavigationBar.barTintColor，也即背景色
    QMUICMI.navBarTintColor = WLColoerRGB(51.f);//UIColorWhite;                                     // NavBarTintColor : QMUINavigationBar 的 tintColor，也即导航栏上面的按钮颜色
    QMUICMI.navBarTitleColor = NavBarTintColor;                                 // NavBarTitleColor : UINavigationBar 的标题颜色，以及 QMUINavigationTitleView 的默认文字颜色
    QMUICMI.navBarTitleFont = UIFontMake(18.f);                               // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
    ...
    QMUICMI.navBarBackIndicatorImage = [UIImage qmui_imageWithShape:QMUIImageShapeNavBack size:CGSizeMake(12, 20) tintColor:WLColoerRGB(51.f)];                                     // NavBarBackIndicatorImage : 导航栏的返回按钮的图片，图片尺寸建议为(13, 21)，否则最终的图片位置无法与系统原生的位置保持一致
    QMUICMI.navBarCloseButtonImage = [UIImage qmui_imageWithShape:QMUIImageShapeNavClose size:CGSizeMake(16, 16) tintColor:WLColoerRGB(51.f)];     // NavBarCloseButtonImage : QMUINavigationButton 用到的 × 的按钮图片
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarShadowImageColor = UIColorSeparator; //WLColoerRGB(51.f);//                          // TabBarShadowImageColor : UITabBar 的 shadowImage 的颜色，会自动创建一张 1px 高的图片
    QMUICMI.tabBarTintColor = WLColoerRGB(153.f);// UIColorMake(4, 189, 231);                         // TabBarTintColor : UITabBar 的 tintColor
    QMUICMI.tabBarItemTitleColor = WLColoerRGB(153.f);// UIColorGray6;                                // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = WLRGB(254.f, 72.f, 30.f);// TabBarTintColor;                     // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
...
#pragma mark - QMUIBadge
    ...
    QMUICMI.updatesIndicatorCenterOffset = CGPointMake(5, -9);                // UpdatesIndicatorCenterOffset : UIBarButtoItem、UITabBarItem 上的未读红点相对于 item 中心的偏移
