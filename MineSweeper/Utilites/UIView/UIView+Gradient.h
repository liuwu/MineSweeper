...
typedef NS_ENUM(NSInteger, WLGradientType) {
    WLGradientFromTopToBottom = 1,            //从上到下
    WLGradientFromLeftToRight,                //从左到右
    WLGradientFromLeftTopToRightBottom,       //从左上到右下
    WLGradientFromLeftBottomToRightTop        //从左下到右上
};
